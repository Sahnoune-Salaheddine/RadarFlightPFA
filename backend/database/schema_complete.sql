-- =====================================================
-- SCHÉMA DE BASE DE DONNÉES COMPLET - FLIGHT RADAR 2026
-- PostgreSQL
-- =====================================================
...
CREATE INDEX idx_weather_alert ON weather_data(alert) WHERE alert = TRUE;
...
-- =====================================================
-- SEED DATA - 4 AÉROPORTS MAROCAINS
-- =====================================================
