...
public class AircraftService {
    ...
    public Optional<Aircraft> getAircraftByPilotUsername(String username) {
        ...
        // Trouver l'avion par pilotId
        List<Aircraft> aircraftList = aircraftRepository.findByPilotId(pilotOpt.get().getId());
        return aircraftList.isEmpty() ? Optional.empty() : Optional.of(aircraftList.get(0));
    }
