-- =====================================================
-- MIGRATION COMPLÈTE - Table flights
-- =====================================================
-- Ce script garantit que toutes les colonnes nécessaires existent
-- et que toutes les contraintes sont correctement configurées
-- =====================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne airline ajoutee';
    ELSE
        RAISE NOTICE 'Colonne airline existe deja';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Colonne flight_number agrandie a VARCHAR(20)';
    ELSE
        RAISE NOTICE 'Colonne flight_number a deja la bonne taille';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne estimated_arrival ajoutee';
    ELSE
        RAISE NOTICE 'Colonne estimated_arrival existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne cruise_altitude ajoutee';
    ELSE
        RAISE NOTICE 'Colonne cruise_altitude existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne cruise_speed ajoutee';
    ELSE
        RAISE NOTICE 'Colonne cruise_speed existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne flight_type ajoutee';
    ELSE
        RAISE NOTICE 'Colonne flight_type existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne alternate_airport_id ajoutee';
    ELSE
        RAISE NOTICE 'Colonne alternate_airport_id existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne estimated_time_enroute ajoutee';
    ELSE
        RAISE NOTICE 'Colonne estimated_time_enroute existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Colonne pilot_id ajoutee';
    ELSE
        RAISE NOTICE 'Colonne pilot_id existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Contrainte fk_flights_alternate_airport ajoutee';
    ELSE
        RAISE NOTICE 'Contrainte fk_flights_alternate_airport existe deja';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Contrainte fk_flights_pilot ajoutee';
    ELSE
        RAISE NOTICE 'Contrainte fk_flights_pilot existe deja';
    END IF;
END $$;
...
BEGIN
    ...
    RAISE NOTICE 'Contrainte CHECK sur flight_status mise a jour';
END $$;

-- =====================================================
-- ÉTAPE 6: Ajouter la contrainte CHECK sur flight_type
-- =====================================================
DO $$
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Contrainte CHECK sur flight_type ajoutee';
    ELSE
        RAISE NOTICE 'Contrainte CHECK sur flight_type existe deja';
    END IF;
END $$;
...
SELECT '=== MIGRATION TERMINEE AVEC SUCCES ===' as info;
