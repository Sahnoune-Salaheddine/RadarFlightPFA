...
public class Airport {
    ...
    private String codeICAO; // Ex: GMMN, GMME, GMMX, GMTT (peut être null si migration incomplète)
    
    @Column(length = 100)
    private String country; // Pays (peut être null si migration incomplète)
