...
# =====================================================
# Ce script supprime les doublons de pilotes dans la base de donnees
# =====================================================

Write-Host ""
Write-Host "================================================" -ForegroundColor Cyan
Write-Host "  NETTOYAGE DOUBLONS PILOTES" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
...
$DB_HOST = "localhost"
$DB_PORT = "5432"
$SCRIPT_FILE = "backend\database\NETTOYER_DOUBLONS_PILOTES.sql"
...
Write-Host "ATTENTION: Ce script va supprimer les doublons de pilotes." -ForegroundColor Yellow
Write-Host "   Seul le premier pilote pour chaque user_id sera conserve." -ForegroundColor Yellow
Write-Host ""
