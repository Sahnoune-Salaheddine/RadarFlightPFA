# =====================================================
# Script PowerShell - Créer et Assigner Avions
# =====================================================
...
Write-Host "  CREATION ET ASSIGNATION AVIONS" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
...
$DB_HOST = "localhost"
$DB_PORT = "5432"
$SCRIPT_FILE = "backend\database\CREER_ET_ASSIGNER_AVIONS_COMPLET.sql"
...
Write-Host "  - Creer les avions manquants (2 par aeroport)" -ForegroundColor White
Write-Host "  - Assigner les aeroports aux pilotes" -ForegroundColor White
Write-Host "  - Assigner les avions aux pilotes (1 pilote = 1 avion)" -ForegroundColor White
Write-Host ""
